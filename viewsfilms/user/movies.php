...
include_once '../templates/popUpSucc.php';
include_once '../navigation/navRight.php';
...
<body>
    <div class="container">
<div style="margin-top: 90px" class="jumbotron bg-secondary">
  <div class="container">
    <h1 class="display-4 text-left text-white">Nos <span style="color: #d67900">Films</span></h1>
    <p class="lead text-left text-white">En tant que membre, vous avez accès à plus de <span style="color: #d67900; font-size: 25px; font-weight: bold">28550 Films</span></p>
  </div>
</div>
</div>
